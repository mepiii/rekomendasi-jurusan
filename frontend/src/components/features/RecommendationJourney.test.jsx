...
describe('RecommendationJourney prodi intake', () => {
  ...
  it('shows English curriculum track labels in English locale', () => {
  ...
  it('renders prodi intake without free-text fields', async () => {
    ...
    await waitFor(() => expect(screen.getByRole('button', { name: 'STEM-heavy classes' })).toBeTruthy());
  ...
  it('submits prodi-specific fields with locale language', async () => {
    ...
    expect(onSubmit).toHaveBeenCalledWith(expect.objectContaining({
      academic_context: { selected: ['STEM-heavy classes'] },
